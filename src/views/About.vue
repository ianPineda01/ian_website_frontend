<template>
  <div class="flex flex-col md:flex-row max-w-screen-md mx-auto">
    <h2>
      ...
      since then he fell in love not only with programming, but also with problem 
      solving, CS, and math in general.
    </h2>
    <img src="../assets/me.jpg" alt="Ian Pineda" class="max-h-screen">
  </div>
</template>
<style scoped>
</style>